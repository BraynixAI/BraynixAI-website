                  ...
                  <ul class="mt-4 flex justify-center gap-6 sm:mt-0 sm:justify-end pt-5">
                    <li className="">
                      <a
                        ...
                        rel="noreferrer"
                        target="_blank"
                        class="transition  hover:text-teal-700/75 text-white"
                      >
                    ...
                    <li>
                      <a
                        ...
                        rel="noreferrer"
                        target="_blank"
                        className="transition  hover:text-teal-700/75 text-white"
            ...
            <div class=" bg-transparent ">
              <div class=" grid grid-cols-3 md:gap-8 gap-4 dark:border-gray-800">
                <div class="">
                  ...
                  <ul class="mt-4 md:mt-8 space-y-4 md:text-sm text-xs">
                    <li>
                      <a
                ...
                <div class="">
                  <p class="md:text-lg text-xs font-medium text-violetPrimery uppercase dark:text-white">
                    Socials
                  </p>

                  <ul class="md:mt-8 mt-4 space-y-4 md:text-sm text-xs">
                    <li>
                      <a
                        class="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                        href="/"
